            ...
            343: () => {
                            ...
                            i(t, [
                                            ...
                                            d(t)
                                                ? (this._c = (function (t, e, n) {
                                                    ...
                                                    for (var r in e)
                                                        h(e[r])
                                                            ? (i[r] = e[r](t, i, n))
                                                            : c("Extension must be a function");
                                                    for (var o in i) h(i[o].mount) && i[o].mount();
                                                    return i;
                                                })(this, t, this._e))
                                                : c("You need to provide a object on `mount()`"),
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        return (
                                            p(t)
                                                ? (this._t = t)
                                                : c("You need to provide a array on `mutate()`"),
                                            this
                                        );
                                    },
                                },
                                    ...
                                    value: function () {
                                        var t =
                                            arguments.length > 0 && void 0 !== arguments[0]
                                                ...
                                                : {};
                                        return (
                                            (this.settings = g(this.settings, t)),
                                ...
                                },
                                {
                                    ...
                                    set: function (t) {
                                        d(t)
                                            ? (this._o = t)
                                            : c("Options must be an `object` instance.");
                                    },
                                },
                                {
                                    key: "index",
                ...
                function N(t) {
                    return d(t)
                        ...
                        : (c("Breakpoints option must be an object"), {});
                    var e;
                }
                var Y = {
                    Html: function (t, e, n) {
                            ...
                            m(i, "root", {
                                ...
                                set: function (t) {
                                    f(t) && (t = document.querySelector(t)),
                                        O(t)
                                            ? (i._r = t)
                                            : c("Root element must be a existing Html node");
                                },
                            }),
                            m(i, "track", {
                                get: function () {
                        ...
                        var i = {
                            set: function (n) {
                                var i = (function (t, e, n) {
                                    var i = [j, E, R, P].concat(t._t, [A]);
                                    return {
                                        mutate: function (n) {
                                            for (var r = 0; r < i.length; r++) {
                                                var o = i[r];
                                                h(o) && h(o().modify)
                                                    ? (n = o(t, e, undefined).modify(n))
                                                    : c(
                        ...
                        return (
                            m(i, "value", {
                                ...
                                set: function (t) {
                                    z.indexOf(t) > -1
                                        ? (i._v = t)
                                        : c("Direction value must be `ltr` or `rtl`");
                                },
                            }),
                    ...
                    Sizes: function (t, e, n) {
                        ...
                        return (
                            ...
                            m(i, "wrapperSize", {
                                get: function () {
                                    return (
                                        i.slideWidth * i.length + e.Gaps.grow + e.Clones.grow
                                    );
                                },
                            }),
                            m(i, "slideWidth", {
                            ...
                            apply: function (t) {
                                for (var n = 0, i = t.length; n < i; n++) {
                                    ...
                                    (r[k[o][0]] =
                                        ...
                                        n !== t.length - 1
                                            ? (r[k[o][1]] = "".concat(this.value / 2, "px"))
                                            : (r[k[o][1]] = "");
                                }
                            },
                            remove: function (t) {
                    ...
                    Clones: function (t, e, n) {
                        var i = {
                            ...
                            collect: function () {
                                ...
                                if (0 !== i.length)
                                    for (
                                        var u = o + +!!t.settings.peek + Math.round(o / 2),
                                        c = i.slice(0, u).reverse(),
                                        l = i.slice(-1 * u),
                                        f = 0;
                                        f < Math.max(a, Math.floor(o / i.length));
                                        f++
                                    ) {
                                        ...
                                        for (var v = 0; v < l.length; v++) {
                                            ...
                                            p.classList.add(s.slide.clone), n.unshift(p);
                                        }
                                    }
                                return n;
                            },
                            ...
                            o = {
                                mount: function () {
                                    (this._n = e.Html.root.querySelectorAll(
                                        ...
                                        (this._c = e.Html.root.querySelectorAll(I)),
                                        (this._arrowControls = {
                    ...
                    Breakpoints: function (t, e, n) {
                        ...
                        return (
                            ...
                            i.on(
                                ...
                                window,
                                _(function () {
                                    t.settings = g(r, a.match(o));
                                }, t.settings.throttle)
                            ),
                            n.on("update", function () {
                                (o = N(o)), (s = Object.assign({}, r));
                            }),
                            n.on("destroy", function () {
                                i.off("resize", window);
                            }),
                        ...
                        var i = t.settings,
                            ...
                            o = {
                                ...
                                lazyLoad: function () {
                                    ...
                                    for (var o = 0; o <= e; o++) {
                                        var s =
                                            this._slideElements[o].getElementsByTagName("img")[0];
                                        s &&
                                    ...
                                    value: function () {
                                        var t =
                                            arguments.length > 0 && void 0 !== arguments[0]
                                                ? arguments[0]
                                                : {};
                                        return a(r(u.prototype), "mount", this).call(
                                            this,
                                            Object.assign({}, Y, t)
                                        );
                                    },
    ...
    (i.m = e),
        ...
        (i.O = (e, n, r, o) => {
            if (!n) {
                ...
                for (l = 0; l < t.length; l++) {
                    for (var [n, r, o] = t[l], a = !0, u = 0; u < n.length; u++)
                        (!1 & o || s >= o) && Object.keys(i.O).every((t) => i.O[t](n[u]))
                            ? n.splice(u--, 1)
                            : ((a = !1), o < s && (s = o));
                    if (a) {
                        t.splice(l--, 1);
        ...
        (() => {
            ...
            var e = (e, n) => {
                ...
                n = (globalThis.webpackChunkfictional_university_theme =
                    globalThis.webpackChunkfictional_university_theme || []);
            n.forEach(e.bind(null, 0)), (n.push = e.bind(null, n.push.bind(n)));
        })();
    var r = i.O(void 0, [350], () => i(343));
    r = i.O(r);
})();
